...
export const MOCK_PACKAGES: TourPackage[] = [
  {
    id: '1',
    name: 'Wonderful Bali Nature',
    category: Category.DOMESTIC,
    subCategory: SubCategory.NATURE,
    destination: 'Ubud, Bali',
    duration: '4D3N',
    facilities: ['Hotel', 'Makan', 'Transport', 'Tiket Wisata'],
    priceAdult: 3500000,
    priceChild: 2500000,
    priceVip: 5000000,
    isWeekday: true,
    isWeekend: true,
    quotaPerDate: { '2023-12-25': 15, '2023-12-30': 10 }
  },
  {
    id: '2',
    ...
    duration: '7D6N',
    facilities: ['Hotel Bintang 5', 'Visa', 'Asuransi', 'Private Guide'],
    priceAdult: 25000000,
    priceChild: 18000000,
    priceVip: 35000000,
    isWeekday: true,
    isWeekend: false,
    quotaPerDate: { '2024-01-15': 5 }
  }
];
